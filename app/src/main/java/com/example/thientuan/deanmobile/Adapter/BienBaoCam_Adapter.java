...
public class BienBaoCam_Adapter extends ArrayAdapter<BienBaoCam> {
    ...
    int[] image = {R.drawable.bienbaocam_dixedap,
            ...
            R.drawable.bienbaocam_xebabanhcodongco1,
            ...
            R.drawable.bienbaocam_hetcamvuot,
            R.drawable.bienbaocam_hethanchetocdo,
            R.drawable.bienbaocam_hetlenhcam,
