...
public class DBHelper_LuatXeMay {
    ...
    public DBHelper_LuatXeMay(Context context) {
    ...
    public ArrayList<LuatXeMay> getAllLuatXeMay(){
        ArrayList<LuatXeMay> arrayList = new ArrayList<>();

        db = context.openOrCreateDatabase(DATABASE_NAME,context.MODE_PRIVATE,null);

        String sql = "select * from Luat where LoaiLuat = 2";
        ...
        while (cursor.moveToNext()){
            ...
            arrayList.add(new LuatXeMay(noidung,mucphat ));
        }
        return arrayList;
    }
}
