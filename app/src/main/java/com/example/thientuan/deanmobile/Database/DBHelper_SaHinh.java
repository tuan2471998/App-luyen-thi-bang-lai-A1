...
public class DBHelper_SaHinh {
    ...
    public DBHelper_SaHinh(Context context) {
    ...
    public ArrayList<SaHinh> getAllSaHinh(){
        ArrayList<SaHinh> arrayList = new ArrayList<>();

        db = context.openOrCreateDatabase(DATABASE_NAME,context.MODE_PRIVATE,null);

        String sql = "select * from LyThuyet where LoaiLT = 3";
        ...
        while (cursor.moveToNext()){
            ...
            arrayList.add(new SaHinh(cauhoi, cautraloi));
        }
        return arrayList;
    }
}
