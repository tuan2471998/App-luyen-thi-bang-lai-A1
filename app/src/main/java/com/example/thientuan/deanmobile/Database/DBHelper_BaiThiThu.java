...
public class DBHelper_BaiThiThu {
    ...
    public DBHelper_BaiThiThu(Context context) {
    ...
    public ArrayList<BaiThiThu> getAllBaiThiThu(){
        ...
        while (cursor.moveToNext()){
            ...
            arrayList.add(new BaiThiThu(cauhoi, dapan1, dapan2, dapan3, dapan4, dapandung));
        }
        return arrayList;
    }
}
