...
public class DBHelper_TuyenDuongDoiNgoai {
    ...
    public DBHelper_TuyenDuongDoiNgoai(Context context) {
    ...
    public ArrayList<TuyenDuongDoiNgoai> getAllTuyenDuongDoiNgoai(){
        ArrayList<TuyenDuongDoiNgoai> arrayList = new ArrayList<>();

        db = context.openOrCreateDatabase(DATABASE_NAME,context.MODE_PRIVATE,null);

        String sql = "select * from ChiTiet_BienBao where id = 6";
        ...
        while (cursor.moveToNext()){
            ...
            arrayList.add(new TuyenDuongDoiNgoai(ten,noidung));
        }
        return arrayList;
    }
}
