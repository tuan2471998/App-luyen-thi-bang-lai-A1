...
public class DBHelper_VachKeDuong {
    ...
    public DBHelper_VachKeDuong(Context context) {
    ...
    public ArrayList<VachKeDuong> getAllVachKeDuong(){
        ArrayList<VachKeDuong> arrayList = new ArrayList<>();

        db = context.openOrCreateDatabase(DATABASE_NAME,context.MODE_PRIVATE,null);

        String sql = "select * from ChiTiet_BienBao where id = 7";
        ...
        while (cursor.moveToNext()){
            ...
            arrayList.add(new VachKeDuong(ten,noidung));
        }
        return arrayList;
    }
}
